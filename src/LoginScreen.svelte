<script lang="ts">
  ...
  <div class="flex min-h-full items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
    <div class="w-full max-w-md space-y-8">
      <div>
        <img class="mx-auto h-21 rounded-full" src="logo.png " alt="Book it!" />
      ...
      <form class="mt-8 space-y-6" on:submit|preventDefault={handleLogin}>
        ...
        <div>
          ...
          >
            <span class="absolute inset-y-0 left-0 flex items-center pl-3">
              ...
              {:else}
                ...
                <svg
                  class="h-5 w-5 text-green-500 group-hover:text-green-400 animate-spin"
                  xmlns="http://www.w3.org/2000/svg"
                  fill="none"
                  viewBox="0 0 24 24"
                  stroke-width="1.5"
          ...
          <button
            type="submit"
            class="group relative flex w-full justify-center rounded-md border border-transparent bg-green-600 py-2 px-4 text-sm font-medium text-white hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-green-500 focus:ring-offset-2 mt-2"
            disabled={loading}
